...
<ol>	
        <li>As you explore the site by viewing objects, you may see objects that you wish to include in your poster. When you click on the object, a new page opens with a large version of the object, and two empty fields. </li>
		<li>The first allows you to make any notes you wish about the item, and to format those notes using simple commands. For example, you may wish to make some notes about how an item is related to another item, or to include some text that you want to include on your poster. </li>
		<li>The second field allows you to tag the item with a keyword. Once you have filled in those fields, you may click the link at the top right of the page that says "activity."</li>
		<li>Click the button that says "Create a new poster." Assign a title to your poster, and fill in the description field with a description of your project. </li>
